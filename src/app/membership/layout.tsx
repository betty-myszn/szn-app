...
export const metadata: Metadata = {
  ...
  description:
    "Apply to MY SZN, where your birth chart and your Human Design are read together instead of separately. Live workshops, subconscious rewiring, a personalised chart and design portal, and a community of ambitious women. Cancel anytime. Limited founding member spots.",
