            ...
            {!paidCommunity && (
              <div className="mt-6 p-4" style={{ border: "var(--border)", background: "var(--lav-light)" }}>
                ...
                <p style={{ fontSize: 12, lineHeight: 1.6, color: "var(--grey)", marginBottom: 10 }}>
                  A live masterclass and astrotapping every month, plus your full personalised season hub, come with MY SZN, $88 a month.
                </p>
                <Link
                  href="/membership"
                  className="no-underline"
              ...
              >
                <div>
                  ...
                  <p style={{ fontSize: 12, color: "rgba(255,255,255,0.6)", lineHeight: 1.6, maxWidth: 460 }}>
                    MY SZN ($88/mo) opens a live masterclass and astrotapping every month, plus your full personalised platform built around your own chart. VIP ($555/mo) adds private monthly coaching with Betty.
                  </p>
                </div>
