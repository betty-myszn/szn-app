    ...
    return (
      <div className="text-center py-8">
        ...
        <p style={{ fontSize: 14, color: "var(--dark)", lineHeight: 1.7 }}>
          We&apos;ll be in touch with details on founding member access, pricing, and launch dates. Your season is about to begin.
        </p>
      </div>
    );
  }
...
export default function MastermindPage() {
  return (
    <div>
      ...
      <section className="px-8 py-20 md:py-28">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-0" style={{ border: "var(--border)", borderTop: "none" }}>
            {[
              { title: "Monthly Live Workshops", desc: "Deep-dive sessions on money, confidence, business, relationships, astrology, and healing. Taught live. Recorded forever.", bg: "var(--mint)" },
              { title: "Live Coaching & Q&A", desc: "Bring your questions. Bring your blocks. Get coached in real time on whatever is standing between you and the version of yourself you keep dreaming about.", bg: "var(--gold)" },
              { title: "Workshop Vault", desc: "Every single live session saved and searchable. Money. Manifestation. Business. Confidence. Healing. Astrology. All yours, forever.", bg: "#fff" },
            ].map((item) => (
      ...
      {/* ═══════════════ WAITLIST CTA (FINAL) ═══════════════ */}
      <section className="px-8 py-20 md:py-28" style={{ background: "var(--pink-light)" }}>
        <div className="max-w-5xl mx-auto">
