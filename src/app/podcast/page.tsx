    ...
    <>
      ...
      <div className="px-8 py-14 text-center" style={{ background: "var(--dark)", borderTop: "var(--border)" }}>
        ...
        <p style={{ fontSize: 14, lineHeight: 1.7, color: "rgba(255,255,255,0.7)", maxWidth: 480, margin: "0 auto 8px" }}>
          Everything from the podcast, taken to the next level. A live masterclass and astro tapping every month, subconscious rewiring and community. Go VIP and you get a 1:1 coaching call with Betty on top.
        </p>
