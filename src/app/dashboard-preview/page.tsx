...
// PREVIEW BUILD of the redesigned "season HQ" dashboard. Lives at /dashboard-preview so the live
// /dashboard keeps working untouched while this is reviewed logged in. When approved this replaces
// the body of /dashboard. Same data + gates as the live page; the difference is the layout: a light
// pastel hero, a scannable top band (today + cosmic weather + a "what do you need" router + a
// personalised "for you" block), then the existing rich reading components, then the toolkit,
// community and vault. The heavy reading sections are reused as-is for now and get restyled next.
