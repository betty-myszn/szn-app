...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* ── 4b. HUMAN DESIGN: the new addition. Sits directly after the birth chart block on
           purpose, because the whole pitch is that it's the second half of the same reading and
           it runs off the same birth details she already gave us. Three numbered steps rather
           than a paragraph, so "how it works" is skimmable for someone who has never heard of
           Human Design and isn't going to read an explainer. ── */}
      <section
      ...
      >
        <div className="max-w-6xl mx-auto">
          <span
            className="sticker"
            style={{ background: "var(--pink)", color: "#fff", marginBottom: 26 }}
          >
            new
          </span>
          <h2 className="display" style={{ fontSize: "clamp(40px, 8vw, 104px)", color: "#fff", marginTop: 18 }}>
            now with your
            <br />
          ...
          >
            Astrology tells you who you&apos;re here to become. Human Design tells you how
            you&apos;re built to get there. You now get both, woven into one read instead of two
            systems you have to reconcile yourself.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 mt-12" style={{ border: "1.5px solid rgba(255,255,255,0.18)" }}>
            {[
              {
                n: "01",
                t: "same birth details",
                b: "Your date, time and place of birth. Nothing new to fill in, nothing to buy. If you've already got your chart with us, your design is already there.",
              },
              {
                n: "02",
              ...
              <div
                key={step.n}
                className="p-8"
                style={{ borderRight: i < 2 ? "1.5px solid rgba(255,255,255,0.18)" : undefined }}
              >
                <div
                  style={{
                    fontFamily: poppins,
          ...
          >
            Then it runs through everything. Your money, your career, your relationships and the
