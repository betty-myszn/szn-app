...
export const RISING_ARCHITECTURE: Record<Sign, RisingArchitecture> = {
  ...
  Aquarius: {
    ...
    keyPieces: {
      tops: { formal: "sculptural shell top", smart: "asymmetric top", casual: "technical knit" },
      ...
      bags: { formal: "sculptural clutch", smart: "metallic crossbody", casual: "technical shoulder bag" },
