...
import { SIGN_TRAITS, BODY_MEANINGS, HOUSE_MEANINGS, ordinalHouse, houseForSign } from "@/lib/interpretations";
...
export function composeTheme(
  ...
  return {
    ...
    inYourChart: `This ${seasonSign.toLowerCase()} szn is lighting up your ${ordinalHouse(activatedHouse)} house of ${houseMeaning.title}, so ${titleWord} plays out through ${houseMeaning.lifeAreas.slice(0, 2).join(" and ")} for you specifically. And your ${sign.toLowerCase()} ${bodyName} (${bodyTitle}) shapes how you experience it: you meet ${titleWord} with ${traits.essence}.`,
